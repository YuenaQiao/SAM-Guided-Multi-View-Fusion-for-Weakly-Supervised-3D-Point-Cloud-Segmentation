...
class Trainer(TrainerBase):
    def __init__(self, cfg):
        ...
        print("Train data_root:", self.train_loader.dataset.data_root)
        print("Val data_root:", self.val_loader.dataset.data_root)
    ...
    def run_step(self):
        ...
        # print("run_step input_dict keys:", input_dict.keys())
